...
```mermaid
graph TD
    A[Conceito IAF: Tech Orgânico] --> B[Estilo Principal: O Sintetizador Orgânico]
    B --> C1[V1: Grade Topográfica - Foco em isolines]
    B --> C2[V2: Terminal Líquido - Foco em código & fluidos]
    B --> C3[V3: Bio-Sinal - Foco em ondas de dados]
    A --> D1[V4: Tela Editorial - Light Mode, Alta costura tech]
    A --> D2[V5: Fluxo Brutalista - Contraste agressivo e cru]
```
